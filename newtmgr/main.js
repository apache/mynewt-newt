...
$packages["mynewt.apache.org/newt/newtmgr/protocol"] = (function() {
	var $pkg = {}, $init, NmgrReq, Reset, sliceType, ptrType, ptrType$1, NewNmgrReq;
	NmgrReq = $pkg.NmgrReq = $newType(0, $kindStruct, "protocol.NmgrReq", true, "mynewt.apache.org/newt/newtmgr/protocol", true, function(Op_, Flags_, Len_, Group_, Seq_, Id_, Data_) {
		this.$val = this;
		if (arguments.length === 0) {
			this.Op = 0;
			this.Flags = 0;
	...
	Reset = $pkg.Reset = $newType(0, $kindStruct, "protocol.Reset", true, "mynewt.apache.org/newt/newtmgr/protocol", true, function() {
		this.$val = this;
		if (arguments.length === 0) {
			return;
		}
	...
	NmgrReq.prototype.SerializeRequest = function(data) { return this.$val.SerializeRequest(data); };
	...
	Reset.prototype.EncodeWriteRequest = function() { return this.$val.EncodeWriteRequest(); };
	ptrType.methods = [{prop: "SerializeRequest", name: "SerializeRequest", pkg: "", typ: $funcType([sliceType], [sliceType, $error], false)}];
	ptrType$1.methods = [{prop: "EncodeWriteRequest", name: "EncodeWriteRequest", pkg: "", typ: $funcType([], [ptrType, $error], false)}];
	NmgrReq.init("", [{prop: "Op", name: "Op", anonymous: false, exported: true, typ: $Uint8, tag: ""}, {prop: "Flags", name: "Flags", anonymous: false, exported: true, typ: $Uint8, tag: ""}, {prop: "Len", name: "Len", anonymous: false, exported: true, typ: $Uint16, tag: ""}, {prop: "Group", name: "Group", anonymous: false, exported: true, typ: $Uint16, tag: ""}, {prop: "Seq", name: "Seq", anonymous: false, exported: true, typ: $Uint8, tag: ""}, {prop: "Id", name: "Id", anonymous: false, exported: true, typ: $Uint8, tag: ""}, {prop: "Data", name: "Data", anonymous: false, exported: true, typ: sliceType, tag: ""}]);
	Reset.init("", []);
	$init = function() {
		$pkg.$init = function() {};
		/* */ var $f, $c = false, $s = 0, $r; if (this !== undefined && this.$blk !== undefined) { $f = this; $c = true; $s = $f.$s; $r = $f.$r; } s: while (true) { switch ($s) { case 0:
...
$packages["main"] = (function() {
	var $pkg = {}, $init, js, protocol, ptrType, funcType, mapType, main, New;
	js = $packages["github.com/gopherjs/gopherjs/js"];
	...
	main = function() {
		$global.reset = $externalize($makeMap($String.keyFor, [{ k: "New", v: new funcType(New) }]), mapType);
	};
	New = function() {
