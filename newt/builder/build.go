...
func NewBuilder(
	...
	// Create the pseudo build packages.  These packages only contain code
	// generated by newt.  By adding these packages now, we ensure the
	// generated code gets included in the build.
